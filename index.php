...
<div class="menu">
	...
	<div class="one"><div id="whead">1 большое дело:</div>
		<div class="workline">
			...
			<label for="w1c"></label>
			<img src="redline.jpg" class="redline" id="rl1"/>
	...
	<div class="three"><div id="whead">3 средних дела:</div>
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl31"/>
		...
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl32"/>
		...
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl33"/>
	...
	<div class="five"><div id="whead">5 маленьких дел:</div>
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl51"/>
		...
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl52"/>
		...
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl53"/>
		...
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl54"/>
		...
		<div class="workline">
			...
			<img src="redline.jpg" class="redline" id="rl55"/>
